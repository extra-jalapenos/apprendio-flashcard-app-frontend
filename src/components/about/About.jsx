...
export default function About() {
  ...
  return (
    <div>
      ...
      <p>&quot;Lernen&quot; is German for &quot;learning&quot;, &quot;Maus&quot; means &quot;mouse&quot;. You get a diminuitive of the latter by appending an -i, becoming an informal, affectionate term. It was also probably the most-used term among the creator of this site and their friends when this site came into existence. You pronounce it a bit like &quot;learnmousy&quot;, but with a more open e, quite dry r and a soft s: <em>[<speak xmlns="http://www.w3.org/2001/10/synthesis" xmlLang="en-GB">lɛɹnmaʊziː</speak>]</em>. It&apos;s not a pre-requisite to know this to sign up, though. To paraphrase Brian Eno – writing about pronunciation is a bit like dancing about architecture.</p>
